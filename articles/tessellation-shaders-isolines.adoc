...
image:/resources/image/catmull-rom-spline[alt=TODO]
...
image:/resources/example[alt=TODO]
...
.Isolines Tessallation Levels Example link:https://www.khronos.org/opengl/wiki_opengl/images/Tessellation_isoline_4_3.png[source]
image:/resources/images/tessellation-shaders-isolines/isoline_level_example.png[alt=Isolines-example]
...
image:/resoures/exmplae[alt=TODO]
...
And voila, the points for a curve is calculated.
...
So for the first isoline, `v == 1`, the line will be forward and up by `0.01`.
The second isoline, `v == 2`, the line will be forward and up by `0.02` and so on.
