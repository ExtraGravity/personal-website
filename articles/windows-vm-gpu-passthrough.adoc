...
The virtual sound card solution seemed to have varying levels of success.
...
It is hard to say whether a single Windows installation would deal well with booting in both a VM and baremetal environment.
